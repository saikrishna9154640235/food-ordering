    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='foodordering.product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateField(auto_created=True)),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('product_measuring', models.CharField(blank=True, choices=[('KG', 'KG'), ('L', 'L'), ('ML', 'ML'), (None, None)], max_length=100, null=True)),
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='meta_information', to='foodordering.product')),
            ],
            options={
                'abstract': False,
            },
